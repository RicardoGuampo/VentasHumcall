...
<div class="card content">
    <div class="card-header content-heade">
      <h3><em>Editar Proveedor: {{ $persona->nombre }}</em></h3>
      @if(count($errors)>0)
    ...
    <div class="card-body was-validated">
      <form method="POST" action="{{ route('proveedor.update',$persona->idpersona) }}"  enctype="multipart/form-data">
          <div class="row">
              {{ method_field('PATCH') }}
              {{ csrf_field() }}
              ...
              <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                      ...
                      <a href="{{ url('/compras/proveedor') }}" title="Regresar"  class="btn btn-success " role="button" aria-pressed="true">
